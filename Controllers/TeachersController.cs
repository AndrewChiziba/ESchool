...
namespace ESchool.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public TeachersController(ESchoolDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Surname,Name,MiddleName,UserId,CourseId")] Teacher teacher)
        {
            if (ModelState.IsValid)
            {
                teacher.FullName = teacher.Surname + " " + teacher.Name + " " + teacher.MiddleName;
