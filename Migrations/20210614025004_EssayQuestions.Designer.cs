...
namespace ESchool.Migrations
{
    ...
    [Migration("20210614025004_EssayQuestions")]
    partial class EssayQuestions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ESchool.Models.Course.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ESchool.Models.CreateEssay.EssayExercise", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("samplefileFilePath")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("EssayExercises");
                });

            modelBuilder.Entity("ESchool.Models.CreateEssay.EssayQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ESchool.Models.EduMaterial.PdfMaterial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ESchool.Models.TranslateExercise.TranslateExercise", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("TranslateExercises");
                });

            modelBuilder.Entity("ESchool.Models.TranslateExercise.TranslateQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("TranslateExerciseId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("TranslateExerciseId");
            ...
            modelBuilder.Entity("ESchool.Models.TranslateExercise.TranslateQuestion", b =>
                {
                    b.HasOne("ESchool.Models.TranslateExercise.TranslateExercise", null)
                        .WithMany("TranslateQuestions")
                        .HasForeignKey("TranslateExerciseId");
                });
            ...
            modelBuilder.Entity("ESchool.Models.TranslateExercise.TranslateExercise", b =>
                {
                    b.Navigation("TranslateQuestions");
                });
